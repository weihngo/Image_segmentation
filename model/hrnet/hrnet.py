...
from .hrnet_module import BasicBlock, Bottleneck
...
class HRNet(nn.Module):
    def __init__(self, c=48, num_classes=8, bn_momentum=0.1):
...
#     model = HRNet(48, 8, 0.1)
#     #model = HRNet(32, 8, 0.1)
#
#     # print(model)
#     #
...
#     print(y.shape)
    ...
    # sum = summary(model.cuda(), torch.rand((1, 3, 256, 256)).cuda())
    # sum.to_excel('data.xls')